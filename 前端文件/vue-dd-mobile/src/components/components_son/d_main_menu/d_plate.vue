...
//        });
      ...
      masterClick(){ //点击开始上工按钮
        ...
        if(_this.$store.getters.home_data.coremainorder){//查看首页订单是否有coremainorder，有就说明有订单
          let coremainorder_state_num=_this.home_order_number.coremainorder.state * 1;  //把'05','0','07','10','11'字符串变number类型
          if(coremainorder_state_num >= 6){
