  ...
  <div class="servicea_bill_box">
      ...
      <div class="service_bill">
          <div class="service_bill_one">
            <span  @click="work_list_click">工单报备</span>
          </div>
          ...
          <div class="service_bill_four">
            <div class="service_bill_four_title" @click="allow_show_click">
              <span>代收款<i>￥200</i></span>
              <span>查看明細<i v-if="allow_upper_show">∧</i><i v-if="allow_lower_show">∨</i></span>
            </div>
  ...
  export default{
      ...
      methods:{
        ...
        allow_show_click(){ //点击查看明细
          let _this=this;
//            this.allow_upper_show=!this.allow_upper_show
//            this.allow_lower_show=!this.allow_lower_show
        ...
        work_list_click(){ //工单报备点击按钮
          ...
          if(_this.$store.getters.home_data.coremainorder){
            ...
            _this.$router.push({name:'report',params: { address:id }});
          }
        },
