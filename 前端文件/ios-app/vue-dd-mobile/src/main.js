...
// import urlAjax from "./static/js/urlAjax"
...
Vue.prototype.$addressUrl=window.URLApi.addressUrl //请求地址
Vue.prototype.$allUrl=window.URLApi.url //URL所有请求地址
Vue.prototype.$ALL=window.URLApi //所有请求地址
