...
<script>
  ...
  export default{
    ...
    created(){
      ...
      let _this=this;
      console.log(_this.$store.getters.weiXinAppid,"dgasjdkasdasfhgsad")
...
initdata(){
      ...
      state_home_data(){//每次进来的时候显示状态
        ...
        if(_this.home_order_number.coremainorder){
          console.log(_this.home_order_number.coremainorder.state,"numnumnumnumnumnum");
...
//            console.log("safdhjasndfkaskdkasdk9999999999999999999我")
...
//            }
      ...
      once_again_state_home_data(self,data){//每次进来的时候显示状态，再次点击
        ...
        if(data == '07'){
          _this.master_text='拍照';
//          console.log("safdhjasndfkaskdkasdk9999999999999999999你")
//          if(common.isWeiXin()){//判断是否是微信浏览器
//            _this.weixin_click();//调取微信拍照
//
//          }
